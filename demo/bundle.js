        ...
        if (requestsTotal === 0) {
          if (latencyThreshold === 0) {
            ...
            setTimeout(() => {
              ...
              console.log(requestsTotal, requestsCompleted);
...
__vue_options__.__file = "/Users/staskjs/Projects/vue-resource-progressbar-interceptor/node_modules/vue-progressbar/vue-progressbar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-70e61f78", __vue_options__)
  } else {
    hotAPI.reload("data-v-70e61f78", __vue_options__)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-70e61f78", module.exports)
  }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../css-loader/index.js!./../vue-loader/lib/style-rewriter.js?id=data-v-70e61f78!./../vue-loader/lib/selector.js?type=styles&index=0!./vue-progressbar.vue", function() {
			var newContent = require("!!./../css-loader/index.js!./../vue-loader/lib/style-rewriter.js?id=data-v-70e61f78!./../vue-loader/lib/selector.js?type=styles&index=0!./vue-progressbar.vue");
...
var _vueProgressbar = __webpack_require__(1);

var _vueProgressbar2 = _interopRequireDefault(_vueProgressbar);

var _vueResourceProgressbarInterceptor = __webpack_require__(0);

var _vueResourceProgressbarInterceptor2 = _interopRequireDefault(_vueResourceProgressbarInterceptor);
...
_vue2.default.use(_vueResourceProgressbarInterceptor2.default);
...
new _vue2.default({
  ...
  methods: {
    ...
    longRequest: function longRequest() {
      this.loading = true;
      this.$http.get('https://httpbin.org/delay/5').finally(this.finish);
    },
    superLongRequest: function superLongRequest() {
      this.loading = true;
